...
| File | Owns |
|---|---|
| `PulseTheme.kt` | The entry point: `PulseTheme(darkTheme, accent: PulseAccent)` — each app picks its lead accent (Spotter Blue, Plate Green, Cookbook Amber, Dragonfly Violet, Magpie Teal — added 2026-07-04, Remnant Rose — added 2026-07-19, Crate Copper — added 2026-07-25, Tote Slate — added 2026-08-15) and layers its own domain-channel CompositionLocal on top |
...
3. `windowSplashScreenAnimatedIcon` = the app's monochrome logo glyph, tinted with the app's lead
   accent (`PulseAccent` base — Blue/Green/Amber/Violet/Teal/Rose/Copper/Slate).
